...
export default function Home() {
  ...
  <div className=""><h2 className="mt-2 mx-2 text-red-600 text-5xl font-bold">Info Tech Institute</h2></div>
  <p className="mt-2 mx-2">
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione velit molestiae ipsa blanditiis. Sed maxime laboriosam nihil voluptate doloribus commodi explicabo laborum corporis aliquam. Vel beatae laudantium amet quod culpa!
  </p>
  
  {/* <button classNameName="bg-sky-500 hover:bg-sky-700 justify-center">
    Save changes
  </button> */}
